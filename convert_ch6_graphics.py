#!/usr/bin/env python3
"""
Complete and accurate conversion of 03.06-graphics.Rmd to PreTeXt XML format
Handles all 741 lines with proper structure and formatting
"""
...
class RmdToPreTeXt:
    ...
    def convert(self, input_file, output_file):
        ...
        self.output.append('')
        self.output.append('<chapter xml:id="ch6-graphics">')
        self.output.append('  <title>Drawing graphs</title>')
...
def main():
    input_file = '/home/runner/work/rbook/rbook/bookdown/03.06-graphics.Rmd'
    output_file = '/home/runner/work/rbook/rbook/pretext/source/ch6-graphics.ptx'
