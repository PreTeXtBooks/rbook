#!/usr/bin/env python3
"""
Complete and accurate conversion of 03.07-datahandling.Rmd to PreTeXt XML format
Handles all 1399 lines with proper structure and formatting
"""
...
class RmdToPreTeXt:
    ...
    def convert(self, input_file, output_file):
        ...
        self.output.append('')
        self.output.append('<chapter xml:id="ch7-data-handling">')
        self.output.append('  <title>Pragmatic matters</title>')
...
def main():
    input_file = '/home/runner/work/rbook/rbook/bookdown/03.07-datahandling.Rmd'
    output_file = '/home/runner/work/rbook/rbook/pretext/source/ch7-data-handling.ptx'
