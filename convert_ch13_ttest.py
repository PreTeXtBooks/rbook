...
class RmdToPreTeXt:
    ...
    def convert(self, input_file, output_file):
        ...
        self.output.append('')
        self.output.append('<chapter xml:id="ch13-ttest">')
        self.output.append('  <title>Comparing two means</title>')
...
def main():
    input_file = '/home/runner/work/rbook/rbook/bookdown/05.13-ttest.Rmd'
    output_file = '/home/runner/work/rbook/rbook/pretext/source/ch13-ttest.ptx'
