#!/usr/bin/env python3
"""
Conversion of 05.12-chisquare.Rmd (775 lines) to PreTeXt XML format
...
class RmdToPreTeXt:
    ...
    def convert(self, input_file, output_file):
        ...
        self.output.append('')
        self.output.append('<chapter xml:id="ch12-chisquare">')
        self.output.append('  <title>Categorical data analysis</title>')
...
def main():
    input_file = '/home/runner/work/rbook/rbook/bookdown/05.12-chisquare.Rmd'
    output_file = '/home/runner/work/rbook/rbook/pretext/source/ch12-chisquare.ptx'
